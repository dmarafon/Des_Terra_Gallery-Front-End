...
describe("Given a DetailArtworkPage", () => {
  ...
  describe("When it's invoked with a user logged in", () => {
    test("Then it will render 3 social media svg icons, 1 logo image and a 1 image for the arwork, a total of 2 images and a button to purchase art", async () => {
      const totalImages = 2;
      ...
      const buyArtButton = screen.getByRole("button", {
        name: "BUY OR RENT",
      });

      expect(buyArtButton).toBeInTheDocument();
