...
import { loadSingleArtworkActionCreator } from "../../redux/features/singleArtworkSlice";
import {
...
export interface SingleArtwork extends Array<IArtworks> {}
...
const MyArtwork = ({
  ...
  const loadSingleArtwork = (artwork: SingleArtwork) => {
  ...
  return (
    <>
      {apiMessage === "Delete Confirmation" && (
        <ModalText
          handleClose={submitClosingModalResponse}
          isOpen={feedback}
          customFunction={""}
        >
          Are you sure that you want to delete? After confirmation this cannot
          be undone
          <p
            data-testid="delete-button"
            className="artwork_button--delete"
            onClick={deleteArt}
          >
            DELETE
          </p>
          ...
          <div className="artwork__container">
            ...
            <div className="artwork__icons--container">
              <div className="artwork__icons--first">
                <NavLink to={`/editart/${id}`}>
                  <svg
                    data-testid="myartwork-test1"
                    onClick={openEditSingleArt}
              ...
              <div className="artwork__icons--second">
                <svg
                  ...
                  onClick={callDeleteConfirmation}
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                >
