...
describe("Given a AddEditForm", () => {
  ...
  describe("When the user fills all the fields, but a General Error occurs", () => {
    const textInput = [
      "Test",
      "oil on canvas",
      "31",
  ...
  describe("When the user fills all the fields, but a Bad Request occurs", () => {
    const textInput = [
      "Test",
      "oil on canvas",
      "31",
  ...
  describe("When the user fills all the fields, but and an image was updated successfully", () => {
    const textInput = [
      "Test",
      "oil on canvas",
      "31",
    ...
    test("Then the dispatch should be invoked and a modal will open warning the user about the update", async () => {
      const fakeFile = new File(["test"], "test.png", { type: "image/png" });
